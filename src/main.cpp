...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("Skuggi GameBoy Emulator", (int)(1280 * main_scale), (int)(800 * main_scale), window_flags);
    if (window == nullptr)
    {
...
#endif
    {
        ...
        gb.getCPU()->setFlag(FlagsEnum::Z, true);
        gb.getCPU()->setFlag(FlagsEnum::N, true);
        gb.getCPU()->setFlag(FlagsEnum::H, true);
        gb.getCPU()->setFlag(FlagsEnum::C, true);
