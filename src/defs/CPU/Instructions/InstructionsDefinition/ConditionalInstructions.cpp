...
uint16_t getRstVectorAddress(const OperatorMnemonicEnum& flag)
{
    switch (flag)
    {
    case OperatorMnemonicEnum::x00:
        return 0x0000;
    case OperatorMnemonicEnum::x08:
        return 0x0008;
    case OperatorMnemonicEnum::x10:
        return 0x0010;
    case OperatorMnemonicEnum::x18:
        return 0x0018;
    case OperatorMnemonicEnum::x20:
        return 0x0020;
    case OperatorMnemonicEnum::x28:
        return 0x0028;
    case OperatorMnemonicEnum::x30:
        return 0x0030;
    case OperatorMnemonicEnum::x38:
        return 0x0038;
    }
}

void pushPcToStack(CPU* cpu)
{
    uint8_t PClsb = cpu->get16bitRegisterValue(RegistersEnum::PC) & 0xFF;
    uint8_t PCmsb = (cpu->get16bitRegisterValue(RegistersEnum::PC) & 0xFF00) >> 8;
...
namespace Instructions
{
    ...
    {
        uint16_t aimedAddress = getRstVectorAddress(param.firstOpMnemonic);
        pushPcToStack(cpu);
